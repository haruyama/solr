...
public class ECNaviTokenizerTest extends TestCase {
    ...
    public void checkToken(final String str, final TestToken[] outTokens)
        ...
        TermAttribute termAtt = (TermAttribute) tokenizer
        ...
        for (int i = 0; i < outTokens.length; i++) {
            ...
            assertEquals("termText", outTokens[i].termText, termAtt.term());
    ...
    public void checkTokenReusable(final String str1, final TestToken[] outTokens1, 
        ...
        for (int i = 0; i < outTokens1.length; i++) {
            ...
            assertEquals(outTokens1[i].termText, termAtt.term());
        ...
        for (int i = 0; i < outTokens2.length; i++) {
            assertTrue(tokenizer.incrementToken());
            assertEquals(outTokens2[i].termText, termAtt.term());
